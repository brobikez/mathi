  ...
  return (
    <div className='my-2 md:mb-6'>
      ...
      <div className="flex justify-center items-center ">
        <form onSubmit={formik.handleSubmit} className="w-full m-5 p-5 md:py-10 md:px-10 shadow-sm shadow-fuchsia-300 bg-fuchsia-100  rounded-xl  ">
        <h1 className="text-center px-6 pb-5  text-xl md:text-2xl font-semibold mb-4">Send your Enquiry</h1>
          <div className="mb-4">
            <input
              type="text"
              name="name"

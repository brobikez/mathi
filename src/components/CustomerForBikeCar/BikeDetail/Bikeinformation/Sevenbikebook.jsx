...
import './fourbikebook.css'; // Import the CSS file for styles
    ...
    <div className="form-container">
      ...
      <div className="form-group">
        ...
        >
          ...
          <option value="carRental">Bike Rental</option>
          <option value="selfDriving">Bike Rental with Self Driving</option>
        </select>
      </div>

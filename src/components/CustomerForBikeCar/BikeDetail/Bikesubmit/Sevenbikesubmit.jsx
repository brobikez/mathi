...
import "./fourbikesubmit.css";

export default function Fourbikesubmit() {
    ...
    <div className="min-h-screen flex flex-col items-center p-6">
      <div className="profile-card shadow-lg overflow-hidden rounded-lg">
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 gap-4">
            <DetailItem label="Bike Model:" value={userDetails.carDetails.model} />
            <DetailItem label="Bike Name:" value={userDetails.carDetails.name} />
